...
{   
    static IEnumerable Lists
    {
        get
        {
            ...
            yield return new TestCaseData("9".ToIntList(), new List<List<int>> { "".ToIntList(), "9".ToIntList() });
            yield return new TestCaseData("98".ToIntList(), new List<List<int>> { "".ToIntList(), "98".ToIntList(), "9".ToIntList(), "8".ToIntList() });
        }
    }
}